...
main_application.title('TextEd')

# Devloper =Label(text = "IMYOURTEXT",bg="pink",fg="black",padx=8,pady=10,font=("comicsansms",12,"bold"),borderwidth=4,relief=SUNKEN)
# Devloper.pack(anchor="center")
